        ...
        <form action="<?php echo base_url(); ?>complaint" method="post">   
            <fieldset class="col-12 mt-2 col-md-12 px-3">
                ...
                <div class="row ">
                    ...
                    <div class="form-group col-sm-9 col-lg-6">
                        <label class="pt-2" for="news_dated">ช่องทาง</label>
                ...
                <div class="row ">
                    ...
                    <!-- <div class="form-group col-sm-9 col-lg-6">
                        ...
                        <input type="text" name="sub_problem" id="sub_problem" class="form-control">
                    </div>   -->
                </div>
                ...
                <div class="row ">
					<div class="form-group col-sm-9 col-lg-6">
                        ...
                        <input type="text" name="government" id="government" class="form-control">
                    </div> 
                    <div class="form-group col-sm-9 col-lg-6">
