...
INSERT INTO `tbl_amphures` (`id`, `code`, `name_th`, `name_en`, `province_id`) VALUES
...
INSERT INTO `tbl_districts` (`id`, `zip_code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
CREATE TABLE `tbl_news_complaint` (
  ...
  `news_address` varchar(255) DEFAULT NULL,
  ...
  `sub_problem` varchar(100) DEFAULT NULL,
...
INSERT INTO `tbl_sub_category` (`sub_category_id`, `sub_category_name`, `sub_category_detail`, `createdDate`) VALUES
(1, 'แจ้งเรื่องแล้ว', NULL, '2020-04-10'),
(2, 'กำลังดำเนินการ', NULL, '2020-04-10'),
(3, 'ปัญหายุติแล้ว', NULL, '2020-04-10'),
(4, 'ประสานงาน', NULL, '0000-00-00'),
(5, 'แจ้งผู้ดำเนินการ', NULL, '0000-00-00');
